              ...
              >
                ...
                <div className={`relative h-64 bg-gradient-to-br ${gradientClass} overflow-hidden`}>
                  ...
                  <div className="absolute top-4 right-4">
                    <span className="bg-white/90 text-neutral-800 px-3 py-1 rounded-full text-sm font-medium flex items-center space-x-1">
                ...
                <div className="p-8">
                  ...
                  <div className="bg-neutral-50 rounded-xl p-6 mb-6">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h4 className="text-xl font-serif font-bold text-neutral-800">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="bg-white border border-neutral-200 rounded-xl p-4 max-h-64 overflow-y-auto">
                      <div className="space-y-3">
                        {showConfirmation.contents.map((item, index) => (
                          <div key={index} className="flex items-start space-x-3 p-2 hover:bg-neutral-50 rounded-lg transition-colors duration-200">
                            <div className="bg-primary-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-medium mt-0.5 flex-shrink-0">
                              {index + 1}
                            </div>
                            <span className="text-neutral-700 text-sm flex-1">{item}</span>
                  ...
                  <div className="bg-blue-50 rounded-xl p-4 mb-6">
                    <h5 className="font-semibold text-neutral-800 mb-3">Packaging & Delivery</h5>
                    <div className="space-y-2 text-sm text-neutral-600">
                      <div className="flex items-center space-x-2">
                        <Package className="h-4 w-4 text-blue-600" />
                        <span>{showConfirmation.packaging}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <MessageCircle className="h-4 w-4 text-blue-600" />
                        <span>{showConfirmation.deliveryInfo}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Special Features */}
                  <div className="mb-8">
                    <h5 className="font-semibold text-neutral-800 mb-3">Special Features</h5>
                  ...
                  <div className="flex space-x-3">
                    <button
                      onClick={() => setShowConfirmation(null)}
                      className="flex-1 border border-neutral-300 text-neutral-700 hover:bg-neutral-50 py-3 px-4 rounded-lg font-medium transition-colors duration-200"
                    >
                      Cancel
                    </button>
                    <button
                      onClick={() => confirmOrder(showConfirmation)}
                      className="flex-1 bg-primary-600 hover:bg-primary-700 text-white py-3 px-4 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center space-x-2"
                    >
          ...
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-screen items-center justify-center p-4">
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div className="p-8">
                  {/* Header */}
                  <div className={`bg-gradient-to-r ${getCategoryGradient(selectedProduct.category)} rounded-xl p-6 mb-6 text-white`}>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                      <div className="mb-6">
                        <h4 className="text-xl font-semibold text-neutral-800 mb-3">Description</h4>
                      ...
                      <div className="mb-6">
                        <h4 className="text-xl font-semibold text-neutral-800 mb-3">Perfect For</h4>
                        <div className="flex flex-wrap gap-2">
                      ...
                      <div className="mb-6">
                        <h4 className="text-xl font-semibold text-neutral-800 mb-3">Special Features</h4>
                    ...
                    <div>
                      <div className="mb-6">
                        <h4 className="text-xl font-semibold text-neutral-800 mb-3">Complete Contents</h4>
                        <div className="bg-neutral-50 rounded-xl p-4 max-h-64 overflow-y-auto">
                          <div className="space-y-2">
                            {selectedProduct.contents.map((item, index) => (
                              <div key={index} className="flex items-start space-x-3 text-sm">
                                <span className="bg-primary-600 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs font-medium mt-0.5">
                                  {index + 1}
                                </span>
                      ...
                      <div className="mb-6">
                        <h4 className="text-xl font-semibold text-neutral-800 mb-3">Packaging & Delivery</h4>
                        <div className="space-y-3">
                          <div className="flex items-center space-x-3">
                            <Package className="h-5 w-5 text-primary-600" />
                            <span className="text-neutral-700">{selectedProduct.packaging}</span>
                          </div>
                          <div className="flex items-center space-x-3">
                            <MessageCircle className="h-5 w-5 text-primary-600" />
                            <span className="text-neutral-700">{selectedProduct.deliveryInfo}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <button
                        ...
                        className="w-full bg-primary-600 hover:bg-primary-700 text-white py-4 px-6 rounded-xl font-semibold text-lg transition-colors duration-200 flex items-center justify-center space-x-2"
                      >
                        <MessageCircle className="h-5 w-5" />
