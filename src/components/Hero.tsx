  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-20 left-10 animate-float">
        <Sparkles className="h-8 w-8 text-primary-300 opacity-60" />
      </div>
      <div className="absolute top-40 right-20 animate-float" style={{ animationDelay: '1s' }}>
        <Sparkles className="h-6 w-6 text-primary-400 opacity-40" />
      </div>
      <div className="absolute bottom-40 left-20 animate-float" style={{ animationDelay: '2s' }}>
        <Sparkles className="h-10 w-10 text-primary-200 opacity-50" />
      </div>
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <div className="animate-fade-in">
          ...
          <div className="h-16 flex items-center justify-center">
            <p className="text-lg text-primary-200 italic transition-all duration-500 ease-in-out">
              "{currentQuote}"
            </p>
          </div>
        </div>

        <div className="animate-slide-up mt-12 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8">
            <button
              ...
              className="bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-xl hover:shadow-2xl flex items-center justify-center space-x-2"
            >
            ...
            <button
              ...
              className="border-2 border-white text-white hover:bg-white hover:text-accent-800 px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105"
            >
              View Ready Hampers
            </button>
          </div>
